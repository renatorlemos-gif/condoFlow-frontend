...
import { FileSpreadsheet, ScanLine, ImageIcon, ClipboardCheck, GitMerge } from "./components/layout/icons";
...
const PAGES = [
  ...
  { id: "escanear-documentos",  label: "Escanear Documentos",  icon: ScanLine,        component: EscanearDocumentos },
